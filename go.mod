...
require (
	...
	github.com/mhalden/gopf v0.0.0-20230814203935-e33457de4c44 // indirect
...
replace github.com/go-freebsd/pf => github.com/mhalden/gopf v0.0.0-20230814205328-4e8715516147
